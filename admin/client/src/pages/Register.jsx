...
import bgFront from '../assets/front.png';
              ...
              <Stack
                ...
                <Box
                  ...
                  <Typography
                    ...
                    Become a GoMachine Supplier and increase your sales by reaching out to a wider audience.
                  </Typography>
                </Box>
                <Stack
                  sx={{
                  ...
                  <form onSubmit={submitHandler}>
                    <FormGroup>
                    <TextField name="name" label="Company Name" value={formData.name} onChange={handleChange} required sx={{
                        color: '#73808c',
                        borderRadius: '10px',
                        fontWeight: '500',
                        fontSize: '15px',
